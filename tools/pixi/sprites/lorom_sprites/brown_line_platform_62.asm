;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; SMW Brown Line-Guided Platform (sprite 62), by imamelia
;;
;; This is a disassembly of sprite 62 in SMW, the brown line-guided platform.
;;
...
!WoodenTile1 = $60		; left tile
!WoodenTile2 = $60		; middle tile
!WoodenTile3 = $62		; right tile
...
BrownLinePlatformMain:

; removed sprite number check (starts at $01D9A7)

;LDY #$18		; there was a check for sprite 63 here, but using $1602,x instead
;STY $00		;

LDA !E4,x	;
PHA		;
SEC		;
SBC #$18		; offset the sprite X position (this was an SBC $00, which is now unnecessary)
STA !E4,x		;        
...
JSR WoodenPlatformGFX	; draw the platform
...
;NoContact:	; this particular sprite never set $1626,x in the first place
...
LineGuideHandlerMainRt:	; $01D74D, main handling routine for all line-guided sprites
...
LDA #!WoodenTile2		;
STA $0306|!Base2,y		; second tile
LDA #!WoodenTile3		;
STA $030A|!Base2,y		; third tile
