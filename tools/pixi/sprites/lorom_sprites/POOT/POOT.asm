        ...
        !CurrentTeleportTarget = $1869|!Base2   ; freeRAM value with the index of the last touched sprite of this type
        ...
        !Tile = $4B                             ; Initial tile
        !SwappedTile = $4D                      ; Palette swapped version of the tile to indicate being ready to teleport
        !TeleportingTile = $6B                  ; Explosion tile used when teleporting is activated
