...
print "An on-off block which only becomes solid when the switch is turned off, but which is triggered by a different switch and RAM address ($7FC0FC) than the normal $14AF|!addr switch."