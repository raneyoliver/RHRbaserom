...
| `$41B839` | 1 | `!HeldInteractionDebug` | held-shell path: `$10` item, `$11` Luigi free, `$12` falling, `$13` not shell, `$30` shell, `$20` hitbox contact, `$40` spinkill, `$41` bounce; death cleanup: `$D0` entered, `$D1` canonical Luigi, `$D2` carried Luigi erased |
| `$41B83A`–`$41B843` | 10 | `!HeldClipDebug` | held-shell clipping snapshot; death cleanup uses `+0` Luigi slot, `+1` status, `+2` `$1470`, `+3` `$148F` |
| `$41B844` | 1 | `!LuigiHeldItem1686Backup` | `$1686` before ignore-objects while Luigi holds |
| `$41B845` | 1 | `!LuigiHeldItem167ABackup` | `$167A` before offscreen-process / no-interact while Luigi holds |
| `$41B846` | 1 | `!DeathPending` | `CleanupLuigiCarryOnDeath.asm` — set at `$71=$09`, gates carried-Luigi cleanup to post-death transitions only |
...
| Range | Notes |
|---|---|
| `$41B847`–`$41B8FF` | After `!DeathPending`, before `!StartRAM` |
...
| Date | Change |
|---|---|
| 2026-07-29 | Reserved `$41B846` for `!DeathPending` (carried-Luigi cleanup across Retry's death reload). |
| 2026-07-27 | Reserved `$41B845` for `!LuigiHeldItem167ABackup` (restore offscreen despawn after hold). |
| 2026-07-27 | Reserved `$41B844` for `!LuigiHeldItem1686Backup` (ignore objects while held). |
